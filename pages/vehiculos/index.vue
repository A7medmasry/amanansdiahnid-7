  ...
  <div>
    ...
    <div v-if="ads[0]">
      <div class="header">
        ...
        <p style="font-size: 20px">vehiculos</p>
      </div>
      <v-container>
        <v-row>
            ...
            <template v-slot:activator="{ on }">
              <div style="position: relative;  width: 100%;">
                <input
                  v-model="search"
                  type="text"
                  placeholder="Buscar en categoría de vehiculos"
                  class="search-ads"
                />
...
export default {
  ...
  async asyncData({ route, app }) {
    let adsTotal = await app.$fireStore.collection("vehiculos").get();
    var ads = [];
      ...
      meta: [
        {
          vmid: "description",
          name: "description",
          content: "Vende carro, jeepeta, camioneta, pasola o motor"
        }
      ]
    };
  },
