  ...
  <div>
    <div v-if="ads[0]">
      <div class="header">
        ...
        <p style="font-size: 20px">inmueebles en alquiler</p>
      </div>
            ...
            <template v-slot:activator="{ on }">
              <div style="position: relative;  width: 100%;">
                <input
                  v-model="search"
                  type="text"
                  placeholder="Buscar en categoría de inmueebles en alquiler"
                  class="search-ads"
...
export default {
  ...
  async asyncData({ route }) {
    let adsTotal = await db.collection("inmueebles-en-alquiler").get();
    var ads = [];
  ...
  head() {
    return {
      title: 'inmueebles en alquiler',
      titleTemplate: "%s ← Klkrd!",
      meta: [
        {
          vmid: "description",
          name: "description",
          content: "Alquila casa, apartamento, villa, solar o local comercial en República Dominicana"
        }
      ]
    };
  },
  beforeMount() {
    db.collection("inmueebles-en-alquiler")
      .get()
      .then(querySnapshot => {
