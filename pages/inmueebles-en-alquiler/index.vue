          ...
          <v-col cols="12" v-for="(ad, index) in filterSearch" :key="ad.id">
            <v-card class="mb-4" raised v-scroll-reveal.reset="{ delay: 800 }">
              <v-row no-gutters>
                ...
                <v-col cols="8">
                  <nuxt-link :to="'/inmueebles-en-alquiler/' + ad.id">
                    <div
                      class="titleAd"
...
export default {
  ...
  async asyncData({ route, app }) {
    let adsTotal = await app.$fireStore
      .collection("inmueebles-en-alquiler")
      .get();
    var ads = [];
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "Alquila casa, apartamento, villa, solar o local comercial en República Dominicana"
        }
      ]
    };
  },
