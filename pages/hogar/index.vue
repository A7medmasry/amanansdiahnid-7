  ...
  <div>
    ...
    <div v-if="ads[0]">
      <div class="header">
        ...
        <p style="font-size: 20px">hogar</p>
      </div>
            ...
            <template v-slot:activator="{ on }">
              <div style="position: relative;  width: 100%;">
                <input
                  v-model="search"
                  type="text"
                  placeholder="Buscar en categoría de hogar"
                  class="search-ads"
                />
...
export default {
  ...
  async asyncData({ route, app }) {
    let adsTotal = await app.$fireStore.collection("hogar").get();
    var ads = [];
      ...
      meta: [
        {
          vmid: "description",
          name: "description",
          content: "Vende cosas nuevas o usadas para el hogar"
        }
      ]
    };
  },
