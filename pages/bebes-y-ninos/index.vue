  ...
  <div>
    ...
    <div v-if="ads[0]">
      <div class="header">
        ...
        <p style="font-size: 20px">bebes y ninos</p>
      </div>
            ...
            <template v-slot:activator="{ on }">
              <div style="position: relative;  width: 100%;">
                <input
                  v-model="search"
                  type="text"
                  placeholder="Buscar en categoría de bebes y ninos"
                  class="search-ads"
                />
          ...
          <v-col cols="12" v-for="(ad, index) in filterSearch" :key="ad.id">
            <v-card class="mb-4" raised v-scroll-reveal.reset="{ delay: 800 }">
              <v-row no-gutters>
                ...
                <v-col cols="8">
                  <nuxt-link :to="'/bebes-y-ninos/' + ad.id">
                    <div
                      class="titleAd"
...
export default {
  ...
  async asyncData({ route, app }) {
    let adsTotal = await app.$fireStore.collection("bebes-y-ninos").get();
    var ads = [];
      ...
      meta: [
        {
          vmid: "description",
          name: "description",
          content: "Vende ropa y accesorios para niños"
        }
      ]
    };
  },
