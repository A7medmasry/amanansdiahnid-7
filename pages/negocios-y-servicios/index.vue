          ...
          <v-col cols="12" v-for="(ad, index) in filterSearch" :key="ad.id">
            <v-card class="mb-4" raised v-scroll-reveal.reset="{ delay: 800 }">
              <v-row no-gutters>
                ...
                <v-col cols="8">
                  <nuxt-link :to="'/negocios-y-servicios/' + ad.id">
                    <div
                      class="titleAd"
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "Oferta de servicios profesionales, curos, equipos profesionales, artículos de oficina, negocios en venta, construcción e industria."
        }
      ]
    };
  },
