  ...
  <div>
    <div v-if="ads[0]">
      <div class="header">
        ...
        <p style="font-size: 20px">negocios y servicios</p>
      </div>
            ...
            <template v-slot:activator="{ on }">
              <div style="position: relative;  width: 100%;">
                <input
                  v-model="search"
                  type="text"
                  placeholder="Buscar en categoría de negocios y servicios"
                  class="search-ads"
...
export default {
  ...
  async asyncData({ route }) {
    let adsTotal = await db.collection("negocios-y-servicios").get();
    var ads = [];
      ...
      meta: [
        {
          vmid: "description",
          name: "description",
          content: "Oferta de servicios profesionales, curos, equipos profesionales, artículos de oficina, negocios en venta, construcción e industria."
        }
      ]
    };
  },
  beforeMount() {
    db.collection("negocios-y-servicios")
      .get()
      .then(querySnapshot => {
